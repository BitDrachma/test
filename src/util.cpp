                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No bitgold.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override bitgold.conf
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                if (!fMatch)
                {
                    ...
                    printf("*** %s\n", strMessage.c_str());
                    uiInterface.ThreadSafeMessageBox(strMessage+" ", string("bitgold"), CClientUIInterface::MSG_WARNING);
                }
            }
        }
        if (fDebug) {

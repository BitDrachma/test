...
{
    uiInterface.ThreadSafeMessageBox(str, _("bitgold"), CClientUIInterface::MSG_ERROR);
    return false;
}

bool static InitWarning(const std::string &str)
{
    uiInterface.ThreadSafeMessageBox(str, _("bitgold"), CClientUIInterface::MSG_WARNING);
    return true;
}
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (filesystem::exists(GetDataDir() / "wallet.dat"))
    {
        ...
        if (r == CDBEnv::RECOVER_OK)
        {
            ...
            uiInterface.ThreadSafeMessageBox(msg, _("bitgold"), CClientUIInterface::MSG_WARNING);
        }
